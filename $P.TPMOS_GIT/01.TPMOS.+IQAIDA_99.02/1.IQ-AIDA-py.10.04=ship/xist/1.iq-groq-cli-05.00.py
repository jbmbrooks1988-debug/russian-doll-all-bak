...
tools = [
    ...
    {'type': 'function', 'function': {'name': 'change_directory', 'description': 'Change CD', 'parameters': {'type': 'object', 'properties': {'path': {'type': 'string'}}, 'required': ['path']}}},
    {'type': 'function', 'function': {'name': 'list_dir', 'description': 'LS', 'parameters': {'type': 'object', 'properties': {'path': {'type': 'string'}}}}}
]

messages = [{'role': 'system', 'content': 'You are a technical coding agent. Use web_search for current news/documentation and other tools for file operations.'}]
