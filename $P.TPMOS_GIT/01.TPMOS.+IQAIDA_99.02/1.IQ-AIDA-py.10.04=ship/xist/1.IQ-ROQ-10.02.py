...
class AtFileCompleter(Completer):
    ...
    def get_completions(self, document, complete_event):
        ...
        if word.startswith('@'):
            rest = word[1:]
            if not rest:
                rest = './'  # ✅ Force CWD completion when user just types @
...
def main():
    ...
    print("\033[94mGrok-TUI v10.4 Active (Stable + @Completer + Full Tools). [Ctrl+C] cancels request. [exit] to quit.\033[0m")
