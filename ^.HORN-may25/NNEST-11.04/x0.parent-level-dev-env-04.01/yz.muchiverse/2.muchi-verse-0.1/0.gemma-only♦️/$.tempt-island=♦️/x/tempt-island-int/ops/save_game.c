 ...
 * Outer-bar action: copies the ENTIRE live pieces/world_tempt_island/ tree into a
 * freshly auto-numbered pieces/saves/save_N/world_tempt_island/ folder via
...
int main(void) {
    ...
    snprintf(world_src, sizeof(world_src), "%s/pieces/world_tempt_island", project_root);
    snprintf(world_dst, sizeof(world_dst), "%s/world_tempt_island", save_dir);
    ...
    snprintf(turn_path, sizeof(turn_path), "%s/pieces/world_tempt_island/map_start/state.txt", project_root);
