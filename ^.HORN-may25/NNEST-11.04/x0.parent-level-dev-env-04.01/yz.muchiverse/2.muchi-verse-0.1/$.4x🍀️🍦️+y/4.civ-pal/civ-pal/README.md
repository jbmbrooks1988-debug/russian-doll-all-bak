# muchi-civ (pure C / TPMOS-family)

GCC C11 rebuild of the Muchi Civ TTY game, on the same architecture as
...
- [x] Minimal `world_muchi_civ_home/map_start` + hero walkable 20x10 map
- [x] Footer legend; METHOD table ready for R2 digit-nav
- [ ] Items, choice nav, activity/talk/scene, full MUCHI CIV floor, GL (R1-R4)
