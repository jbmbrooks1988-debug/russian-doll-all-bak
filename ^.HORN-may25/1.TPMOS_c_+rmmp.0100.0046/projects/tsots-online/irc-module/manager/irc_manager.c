...
static void resolve_paths(void) {
    ...
    if (getcwd(cwd, sizeof(cwd))) {
        char probe[MAX_PATH];
        snprintf(probe, sizeof(probe), "%s/projects/tsots-online/irc-module", cwd);
            ...
            while (fgets(line, sizeof(line), f)) {
                ...
                *eq = '\0';
                ...
                if (strcmp(k, "project_root") == 0) {
                    char probe[MAX_PATH];
                    snprintf(probe, sizeof(probe), "%s/projects/tsots-online/irc-module", project_root);
                    if (access(probe, F_OK) != 0) {
    ...
    snprintf(gui_state_path, sizeof(gui_state_path), "%s/projects/tsots-online/irc-module/manager/gui_state.txt", project_root);
    snprintf(history_path, sizeof(history_path), "%s/pieces/apps/player_app/history.txt", project_root);
    snprintf(ledger_path, sizeof(ledger_path), "%s/projects/tsots-online/irc-module/chat_ledger.txt", project_root);
    snprintf(node_cfg_path, sizeof(node_cfg_path), "%s/projects/tsots-online/irc-module/node_config.txt", project_root);
    snprintf(known_hosts_path, sizeof(known_hosts_path), "%s/projects/tsots-online/irc-module/known_hosts.pdl", project_root);
    snprintf(users_path, sizeof(users_path), "%s/projects/tsots-online/irc-module/ring_users.txt", project_root);
    snprintf(debug_path, sizeof(debug_path), "%s/projects/tsots-online/irc-module/ring_debug.log", project_root);
}
