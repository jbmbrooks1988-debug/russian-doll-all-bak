 ...
 * opened the same way db-hq / events-hq / ai-cell / context-menu open
 ...
 * CSS: <house>/xyzfs/bin/livedesk-clock/reminder.css. Scale:
...
int main(int argc, char **argv) {
    ...
    snprintf(css_path, sizeof(css_path), "%s/xyzfs/bin/livedesk-clock/reminder.css", g_house_root);
    CssSheet sheet;
