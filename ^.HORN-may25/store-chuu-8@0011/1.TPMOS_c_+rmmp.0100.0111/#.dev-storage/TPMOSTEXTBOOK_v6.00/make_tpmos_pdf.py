...
BASE_DIR = SCRIPT_DIR
OUTPUT_PDF = os.path.join(SCRIPT_DIR, "TPMOS_TEXTBOOK_v6.00.pdf")
...
class TPMOS_PDF(FPDF):
    def header(self):
        if self.page_no() > 1:
            ...
            header_text = clean_emojis("📚 TPMOS TEXTBOOK v6.00 🎓  ")
...
def create_pdf():
    ...
    pdf.cell(0, 10, "Version 6.00 (Standardized Ops Edition)", align="C", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
    pdf.ln(80)
