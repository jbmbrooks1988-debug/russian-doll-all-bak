...
static void render_body(const char *root, const GameState *st) {
    ...
    snprintf(op_path, sizeof(op_path),
             "%s/projects/wraith-alpha/wraith-projects/piececraft-wraith/ops/+x/render_map_wraith.+x", root);
...
static void write_scene(const char *root, const GameState *st) {
    ...
    fprintf(f, "OBJECT tag=control id=control_map role=window_toolbar_item x=35 y=5 w=26 h=1 z=26 nav=5 source=semantic:window_toolbar fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=INTERACT target_surface=game_map label=Control_Map\n");
    ...
    fprintf(f, "OBJECT tag=model id=piececraft_map_01 role=tile_zmap x=35 y=6 w=48 h=14 z=23 "
               ...
               "label=MAP_SOURCE:source=maps/%s_z%d.txt;registry=assets/tiles/registry.txt;z=%d;selected=%d,%d,%d;pet=%d,%d;mode=%s;camera=%d,%.2f,%.2f,%.2f,15.00,0.00,0.00\n",
            st->active_map_id, st->xel_z, st->active_map_id, st->xel_z, st->xel_z, st->xel_x, st->xel_y, st->xel_z,
            st->pet_x, st->pet_y,
            st->display_mode == 0 ? "2d" : "3d",
            st->camera_mode, st->cam_pan_x, st->cam_pan_y, st->cam_pan_z);
    fprintf(f, "OBJECT tag=control id=btn_up role=game_button x=84 y=6 w=14 h=1 z=25 nav=6 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:1002 label=[Up]\n");
    fprintf(f, "OBJECT tag=control id=btn_down role=game_button x=84 y=7 w=14 h=1 z=25 nav=7 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:1003 label=[Down]\n");
    fprintf(f, "OBJECT tag=control id=btn_left role=game_button x=84 y=8 w=14 h=1 z=25 nav=8 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:1000 label=[Left]\n");
    fprintf(f, "OBJECT tag=control id=btn_right role=game_button x=84 y=9 w=14 h=1 z=25 nav=9 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:1001 label=[Right]\n");
    fprintf(f, "OBJECT tag=control id=btn_ascend role=game_button x=84 y=10 w=14 h=1 z=25 nav=10 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:101 label=[E] Z-Level Up\n");
    fprintf(f, "OBJECT tag=control id=btn_descend role=game_button x=84 y=11 w=14 h=1 z=25 nav=11 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:113 label=[Q] Z-Level Dn\n");
    fprintf(f, "OBJECT tag=control id=btn_mode role=game_button x=84 y=12 w=14 h=1 z=25 nav=12 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:56 label=[8] 2D/3D\n");
    fprintf(f, "OBJECT tag=control id=btn_debug role=game_button x=84 y=13 w=14 h=1 z=25 nav=13 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:57 label=[9] Debug\n");
    ...
    fprintf(f, "OBJECT tag=text id=cam_hud role=game_hud x=84 y=18 w=22 h=1 z=25 nav=0 "
               "source=- fg=#7EDFF2 bg=#0B1118 border=#0B1118 action=- "
               "label=Camera: POV%d\n", st->camera_mode);
    fprintf(f, "OBJECT tag=control id=btn_cam_fwd role=game_button x=84 y=19 w=14 h=1 z=25 nav=14 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:119 label=[W] Cam Fwd\n");
    fprintf(f, "OBJECT tag=control id=btn_cam_back role=game_button x=84 y=20 w=14 h=1 z=25 nav=15 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:115 label=[S] Cam Back\n");
    fprintf(f, "OBJECT tag=control id=btn_cam_left role=game_button x=84 y=21 w=14 h=1 z=25 nav=16 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:97 label=[A] Cam Left\n");
    fprintf(f, "OBJECT tag=control id=btn_cam_right role=game_button x=84 y=22 w=14 h=1 z=25 nav=17 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:100 label=[D] Cam Right\n");
    fprintf(f, "OBJECT tag=control id=btn_cam_up role=game_button x=84 y=23 w=14 h=1 z=25 nav=18 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:120 label=[X] Cam Up\n");
    fprintf(f, "OBJECT tag=control id=btn_cam_down role=game_button x=84 y=24 w=14 h=1 z=25 nav=19 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:122 label=[Z] Cam Down\n");
    fprintf(f, "OBJECT tag=control id=btn_pov1 role=game_button x=84 y=25 w=14 h=1 z=25 nav=20 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:49 label=[1] POV-1\n");
    fprintf(f, "OBJECT tag=control id=btn_pov2 role=game_button x=84 y=26 w=14 h=1 z=25 nav=21 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:50 label=[2] POV-2\n");
    fprintf(f, "OBJECT tag=control id=btn_pov3 role=game_button x=84 y=27 w=14 h=1 z=25 nav=22 source=- fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=KEY:51 label=[3] POV-3\n");
