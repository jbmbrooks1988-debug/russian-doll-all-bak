...
static void write_scene(const char *root, const RecordState *state) {
    ...
    fprintf(f, "OBJECT tag=control id=record_start role=chtmgl_button x=5 y=12 w=8 h=1 z=30 nav=5 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:SCREENREC_START label=Start\n", poster_ref);
    fprintf(f, "OBJECT tag=control id=record_stop role=chtmgl_button x=14 y=12 w=8 h=1 z=30 nav=6 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:SCREENREC_STOP label=Stop\n", poster_ref);
    fprintf(f, "OBJECT tag=control id=record_refresh role=chtmgl_button x=5 y=14 w=17 h=1 z=30 nav=7 source_ref=%s fg=#E8F1F2 bg=#22384A border=#FFD166 action=PROJECT_ACTION:SCREENREC_REFRESH label=Refresh\n", poster_ref);
