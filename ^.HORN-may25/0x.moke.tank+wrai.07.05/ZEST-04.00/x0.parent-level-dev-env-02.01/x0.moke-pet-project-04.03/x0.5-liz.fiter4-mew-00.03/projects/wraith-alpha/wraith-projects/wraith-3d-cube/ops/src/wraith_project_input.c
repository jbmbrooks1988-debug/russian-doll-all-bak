...
static void write_scene(const char *root, const CubeState *state) {
    ...
    fprintf(f, "OBJECT tag=control id=control_map role=window_toolbar_item x=35 y=5 w=24 h=1 z=26 nav=5 source=semantic:window_toolbar fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=INTERACT target_surface=game_map label=Control_Map\n");
