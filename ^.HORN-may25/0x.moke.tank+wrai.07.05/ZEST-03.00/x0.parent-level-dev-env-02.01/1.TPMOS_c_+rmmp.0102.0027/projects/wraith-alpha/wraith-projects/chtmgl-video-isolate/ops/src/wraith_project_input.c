...
static void write_scene(const char *root, const VideoProbeState *state) {
    ...
    fprintf(f, "OBJECT tag=control id=video_play role=chtmgl_button x=5 y=12 w=8 h=1 z=30 nav=5 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:VIDEO_PLAY label=Play\n", video_scene_ref);
    fprintf(f, "OBJECT tag=control id=video_pause role=chtmgl_button x=14 y=12 w=8 h=1 z=30 nav=6 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:VIDEO_PAUSE label=Pause\n", video_scene_ref);
    fprintf(f, "OBJECT tag=control id=video_resume role=chtmgl_button x=5 y=14 w=8 h=1 z=30 nav=7 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:VIDEO_RESUME label=Resume\n", video_scene_ref);
    fprintf(f, "OBJECT tag=control id=video_stop role=chtmgl_button x=14 y=14 w=8 h=1 z=30 nav=8 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:VIDEO_STOP label=Stop\n", video_scene_ref);
    fprintf(f, "OBJECT tag=control id=video_refresh role=chtmgl_button x=5 y=16 w=17 h=1 z=30 nav=9 source_ref=%s fg=#E8F1F2 bg=#22384A border=#FFD166 action=PROJECT_ACTION:VIDEO_REFRESH label=Refresh_Poster\n", video_scene_ref);
