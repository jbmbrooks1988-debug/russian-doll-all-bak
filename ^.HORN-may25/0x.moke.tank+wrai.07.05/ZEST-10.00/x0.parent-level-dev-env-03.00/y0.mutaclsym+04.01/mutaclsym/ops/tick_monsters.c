 ...
 * CURRENT map's monsters/ directory takes one simple action - step one
 * tile toward the hero (chase AI, diagonal moves allowed, blocked by the
 * same terrain/furniture rules as the hero and by other monsters), or,
 * if that step would land on the hero's own tile, attack instead of
