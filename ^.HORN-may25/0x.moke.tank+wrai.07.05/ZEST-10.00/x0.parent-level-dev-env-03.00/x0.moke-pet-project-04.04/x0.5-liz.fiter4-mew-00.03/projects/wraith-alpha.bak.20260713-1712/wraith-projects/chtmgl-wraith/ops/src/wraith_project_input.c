...
static void write_scene(const char *root, const ImageProbeState *state) {
    ...
    fprintf(f, "OBJECT tag=control id=btn_test role=chtmgl_button x=5 y=8 w=16 h=1 z=30 nav=5 source=reference:chtmgl-alpha fg=#E8F1F2 bg=#22384A border=#FFD166 action=EVENT:test_click label=Test_Button\n");
    fprintf(f, "OBJECT tag=control id=chk_feature role=chtmgl_checkbox x=5 y=10 w=18 h=1 z=30 nav=6 source=reference:chtmgl-alpha fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=EVENT:toggle_feature label=Enable_Feature\n");
    fprintf(f, "OBJECT tag=control id=slider_volume role=chtmgl_slider x=5 y=12 w=18 h=1 z=30 nav=7 source=reference:chtmgl-alpha fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=EVENT:slider_volume label=Volume_50\n");
    ...
    fprintf(f, "OBJECT tag=control id=audio_play role=chtmgl_button x=62 y=21 w=8 h=1 z=30 nav=10 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:AUDIO_PLAY label=Play\n",
        audio_scene_ref);
    fprintf(f, "OBJECT tag=control id=audio_pause role=chtmgl_button x=71 y=21 w=8 h=1 z=30 nav=11 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:AUDIO_PAUSE label=Pause\n",
        audio_scene_ref);
    fprintf(f, "OBJECT tag=control id=audio_resume role=chtmgl_button x=62 y=22 w=8 h=1 z=30 nav=12 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:AUDIO_RESUME label=Resume\n",
        audio_scene_ref);
    fprintf(f, "OBJECT tag=control id=audio_stop role=chtmgl_button x=71 y=22 w=8 h=1 z=30 nav=13 source_ref=%s fg=#E8F1F2 bg=#22384A border=#7EDFF2 action=PROJECT_ACTION:AUDIO_STOP label=Stop\n",
        audio_scene_ref);

    fprintf(f, "OBJECT tag=control id=menu_options role=chtmgl_menu x=64 y=6 w=16 h=1 z=30 nav=8 source=reference:chtmgl-alpha fg=#E8F1F2 bg=#2A3E52 border=#FFD166 action=EVENT:menu_options label=Options\n");
    fprintf(f, "OBJECT tag=control id=control_surface role=window_toolbar_item x=54 y=23 w=24 h=1 z=32 nav=9 source=semantic:window_toolbar fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=INTERACT target_surface=game_map label=Control_Surface\n");
