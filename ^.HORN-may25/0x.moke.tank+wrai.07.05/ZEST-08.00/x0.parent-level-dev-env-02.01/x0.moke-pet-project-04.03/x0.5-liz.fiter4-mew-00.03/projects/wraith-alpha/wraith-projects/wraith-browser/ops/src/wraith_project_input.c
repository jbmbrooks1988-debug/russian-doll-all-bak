...
static void build_outputs(const char *root, const BrowserState *st, const ScriptState *script) {
    ...
    snprintf(line, sizeof(line), "OBJECT tag=control id=browser_search role=window_toolbar_item x=18 y=7 w=88 h=1 z=30 nav=5 source=semantic:browser_search fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=INTERACT label=%s src=\n", st->address_input);
    strncat(scene_buf, line, sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_home role=window_toolbar_item x=18 y=9 w=12 h=1 z=30 nav=6 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_HOME label=Home src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_audit role=window_toolbar_item x=31 y=9 w=12 h=1 z=30 nav=7 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_AUDIT label=Audit src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_js_lab role=window_toolbar_item x=44 y=9 w=14 h=1 z=30 nav=8 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_JS_LAB label=JS_Lab src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_back role=window_toolbar_item x=59 y=9 w=11 h=1 z=30 nav=9 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_BACK label=Back src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_forward role=window_toolbar_item x=71 y=9 w=14 h=1 z=30 nav=10 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_FORWARD label=Forward src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_reload role=window_toolbar_item x=86 y=9 w=12 h=1 z=30 nav=11 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_RELOAD label=Reload src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_toggle_js role=window_toolbar_item x=18 y=10 w=16 h=1 z=30 nav=12 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_TOGGLE_JS label=Toggle_JS src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_js_inc role=window_toolbar_item x=35 y=10 w=10 h=1 z=30 nav=13 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_JS:counter_inc label=JS+1 src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
    strncat(scene_buf, "OBJECT tag=control id=browser_js_reset role=window_toolbar_item x=46 y=10 w=14 h=1 z=30 nav=14 source=semantic:browser_nav fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=PROJECT_ACTION:BROWSER_JS:counter_reset label=JS_Reset src=\n", sizeof(scene_buf) - strlen(scene_buf) - 1);
