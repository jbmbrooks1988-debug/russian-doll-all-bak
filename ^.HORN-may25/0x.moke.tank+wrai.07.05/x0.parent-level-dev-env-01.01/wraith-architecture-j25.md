...
- `projects/wraith/wraith-projects/<project>/project.pdl`
- `projects/wraith/wraith-projects/<project>/layouts/*.chtpm`
- `projects/wraith/wraith-projects/<project>/session/state.txt`
- `projects/wraith/wraith-projects/<project>/session/wraith_body.txt`
- `projects/wraith/wraith-projects/<project>/session/scene.objects.pdl`
- `projects/wraith/wraith-projects/<project>/pieces/**`
- `projects/wraith/wraith-projects/<project>/maps/**`
- `projects/wraith/wraith-projects/<project>/assets/**`
...
- project scene files declare a selectable surface with `nav=<n>` and `action=INTERACT`
- Wraith shell nav shows `[>]` when that surface is selected but not active
- pressing Enter on that nav sets the active project's `session/state.txt` key `is_map_control=1`
- the active surface then shows `[^]`, meaning keyboard ownership is inside the `${game_map}` surface
...
- do not create top-level TPMOS projects for `wraith-3d-cube`, `piececraft-wraith`, `chtmgl-wraith`, or `emoji-studio-wraith`
