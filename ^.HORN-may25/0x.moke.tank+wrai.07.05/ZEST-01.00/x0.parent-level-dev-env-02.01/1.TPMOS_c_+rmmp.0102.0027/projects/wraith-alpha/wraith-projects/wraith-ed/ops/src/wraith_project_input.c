...
static void write_scene(const char *root, const EditorState *st) {
    ...
    fprintf(f, "OBJECT tag=control id=control_editor_map role=window_toolbar_item x=4 y=7 w=24 h=1 z=30 nav=5 source=semantic:project_control fg=#E8F1F2 bg=#122333 border=#7EDFF2 action=INTERACT target_surface=game_map label=Control_Editor_Map\n");
    fprintf(f, "OBJECT tag=control id=load_map role=chtmgl_button x=4 y=9 w=13 h=1 z=30 nav=6 source=reference:op-ed fg=#E8F1F2 bg=#22384A border=#FFD166 action=EDITOR:load_map label=Load_Map\n");
    fprintf(f, "OBJECT tag=control id=place_glyph role=chtmgl_button x=18 y=9 w=12 h=1 z=30 nav=7 source=reference:op-ed fg=#E8F1F2 bg=#22384A border=#FFD166 action=EDITOR:place_glyph label=Place_%c\n", st->active_glyph);
    fprintf(f, "OBJECT tag=control id=save_game role=chtmgl_button x=4 y=11 w=13 h=1 z=30 nav=8 source=reference:op-ed fg=#E8F1F2 bg=#22384A border=#FFD166 action=EDITOR:save_game label=Save_Game\n");
    fprintf(f, "OBJECT tag=control id=pal_event role=chtmgl_button x=18 y=11 w=12 h=1 z=30 nav=9 source=reference:op-ed fg=#E8F1F2 bg=#22384A border=#FFD166 action=EDITOR:pal_event label=PAL_Event\n");
    fprintf(f, "OBJECT tag=control id=export_game role=chtmgl_button x=4 y=13 w=13 h=1 z=30 nav=10 source=reference:op-ed fg=#E8F1F2 bg=#22384A border=#FFD166 action=EDITOR:export label=Export\n");
