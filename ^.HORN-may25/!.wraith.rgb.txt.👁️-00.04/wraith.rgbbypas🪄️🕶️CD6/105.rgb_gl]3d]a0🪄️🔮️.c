...
void read_rgb() {
    ...
    char msg[256];
    snprintf(msg, sizeof(msg), "Loaded %d primitives and %d texts from %s", num_primitives, num_texts, rgb_path);
    log_to_file(msg);
}
...
void display() {
    ...
    glMatrixMode(GL_PROJECTION);
    glLoadIdentity();
    gluPerspective(60.0f, (float)WINDOW_WIDTH / WINDOW_HEIGHT, 0.01f, 200.0f);
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
...
int main(int argc, char *argv[]) {
    ...
    glutCreateWindow("RGB GL Display");
