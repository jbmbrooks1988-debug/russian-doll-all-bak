...
# book-stack is a DESKTOP ENTITY: #.desktop/entities/book-stack is the
# window (hosted by tp_desktop_window), and its Read method runs the
# reader app (@.apps/book-stack/pieces/reader/event_pkg/pages/page_1/
...
ENTITY_DIR="$HOUSE_DIR/#.desktop/entities/book-stack"
EVENT_PAL="$SCRIPT_DIR/pieces/reader/event_pkg/pages/page_1/event.pal"

entity_window_up() {
    pgrep -f "$ENTITY_DIR" >/dev/null 2>&1
}
