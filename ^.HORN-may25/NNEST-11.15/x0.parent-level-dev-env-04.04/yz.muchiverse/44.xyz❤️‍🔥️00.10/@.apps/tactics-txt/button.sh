...
case "$ACTION" in
    ...
    run|r|start)
        ...
        ln -s "$SCRIPT_DIR/projects/tactics-txt/pieces" "$SESSION_DIR/projects/tactics-txt/pieces"
        ...
        ln -sfn "$SCRIPT_DIR/pieces/battle_01" "$SESSION_DIR/pieces/battle_01"
...
EOUNITS
        ...
        ln -sf "$SCRIPT_DIR/pieces/system/units.txt" "$SESSION_DIR/pieces/system/units.txt"
