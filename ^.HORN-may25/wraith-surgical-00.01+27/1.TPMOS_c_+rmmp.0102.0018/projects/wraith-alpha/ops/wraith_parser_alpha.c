...
static bool handle_desktop_action_command(const char* cmd) {
    ...
    if (idx == 3) {
        ...
        terminal_count = 0;
        apply_desktop_ui_state(terminal_collapsed, terminal_fullscreen, false, terminal_count);
        if (current_module_pid > 0) {
            kill(current_module_pid, SIGTERM);
            current_module_pid = 0;
        }
    } else if (idx == 5) {
        /* First fix: dock activation must open one real terminal instance. */
        terminal_count = 1;
...
void load_vars() {
    ...
    if (strlen(get_var("desktop_window_1_halfscreen_visible")) == 0) set_var("desktop_window_1_halfscreen_visible", "true");
    {
        ...
        set_var("desktop_window_1_body_visible", (!strcmp(get_var("desktop_window_1_open"), "true") && !terminal_collapsed) ? "true" : "false");
        ...
        if (terminal_count > 0) {
            ...
            set_var("desktop_window_1_open", "true");
            set_var("desktop_window_1_hidden", "false");
        } else {
