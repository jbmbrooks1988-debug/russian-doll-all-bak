...
The manager (`gem-api_manager.c`) is designed for maximum responsiveness and system health:
...
- **Sandbox Mode:** All tool executions (read/write/exec) are confined to `projects/gem-api/sandbox`.
