# tempt-island (pure C / TPMOS-family)

GCC C11 rebuild of the Tempt Island TTY game, on the same architecture as
...
- [x] Minimal `world_tempt_island/map_start` + hero walkable 20x10 map
- [x] Footer legend; METHOD table ready for R2 digit-nav
- [ ] Items, choice nav, activity/talk/scene, full TEMPT ISLAND floor, GL (R1-R4)
