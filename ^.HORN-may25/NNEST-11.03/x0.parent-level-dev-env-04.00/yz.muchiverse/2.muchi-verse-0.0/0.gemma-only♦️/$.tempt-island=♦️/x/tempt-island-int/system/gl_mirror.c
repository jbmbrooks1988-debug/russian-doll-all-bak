/* gl_mirror - the ONLY file in tempt-island allowed to call GL/GLUT
 ...
 * tempt-island has no window manager and no semantic-object click targets
 ...
 *     frame; tempt-island has no such pulse-file convention yet, so this
...
static void update_focus_lock(void) {
    ...
    fprintf(f, "project=tempt-island\n");
    fclose(f);
}
...
int main(int argc, char **argv) {
    ...
    glutCreateWindow("tempt-island RGB mirror");
