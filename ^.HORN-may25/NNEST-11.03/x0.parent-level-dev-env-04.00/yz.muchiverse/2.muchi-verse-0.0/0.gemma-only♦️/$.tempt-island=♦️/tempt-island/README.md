# muchimon-pal (pure C / TPMOS-family)

GCC C11 rebuild of the Muchimon TTY game, on the same architecture as
...
- [x] Minimal `world_muchimon_home/map_start` + hero walkable 20x10 map
- [x] Footer legend; METHOD table ready for R2 digit-nav
- [ ] Items, choice nav, activity/talk/scene, full MUCHIMON floor, GL (R1-R4)
