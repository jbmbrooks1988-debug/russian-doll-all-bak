...
#pragma GCC diagnostic pop
    ...
    if (z != 0) {
        snprintf(header_text, sizeof(header_text), "MUCHI CIV  map: %-10s turn: %d  Floor: %d", map_id, turn, z);
    } else {
        snprintf(header_text, sizeof(header_text), "MUCHI CIV  map: %-10s turn: %d", map_id, turn);
    }
