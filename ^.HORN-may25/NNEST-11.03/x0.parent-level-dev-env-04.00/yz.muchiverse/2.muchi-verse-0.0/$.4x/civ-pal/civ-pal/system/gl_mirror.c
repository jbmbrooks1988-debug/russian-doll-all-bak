/* gl_mirror - the ONLY file in muchi-civ allowed to call GL/GLUT
 ...
 * muchi-civ has no window manager and no semantic-object click targets
 ...
 *     frame; muchi-civ has no such pulse-file convention yet, so this
...
int main(int argc, char **argv) {
    ...
    glutCreateWindow("muchi-civ RGB mirror");
