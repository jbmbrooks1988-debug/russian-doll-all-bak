/* gl_mirror - the ONLY file in pal-craft allowed to call GL/GLUT
 ...
 * pal-craft has no window manager and no semantic-object click targets
 ...
 *     frame; pal-craft has no such pulse-file convention yet, so this
...
int main(int argc, char **argv) {
    ...
    glutCreateWindow("pal-craft RGB mirror");
