/* gl_mirror - the ONLY file in muchimon-pal allowed to call GL/GLUT
 ...
 * muchimon-pal has no window manager and no semantic-object click targets
 ...
 *     frame; muchimon-pal has no such pulse-file convention yet, so this
...
static void update_focus_lock(void) {
    ...
    fprintf(f, "project=muchipal-editor\n");
    fclose(f);
}
...
int main(int argc, char **argv) {
    ...
    glutCreateWindow("muchipal-editor RGB mirror");
