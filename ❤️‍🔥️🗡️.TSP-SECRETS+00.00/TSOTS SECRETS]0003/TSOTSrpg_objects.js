...
///////////////////_))_))))__)_))_)#)#)*#)#*_)@*_)@#*  Game_Action.prototype.itemEffectRemoveDebuff
...
//////////////+++__***^^^##34928329; ====___----- ^%### *(#^^   Game_BattlerBase.prototype.initialize)
...
Game_Map.prototype.isEventRunning = function() {
   /// console.log("Runningevent");///superloop ======================Loopingeventlistener Game_Map
...
Game_Map.prototype.setupEvents = function() {
    this._events = [];
    console.log(this._events);     console.log("MapEventsArray");  ///////=============///////=====
    console.log(this);
...
Game_CharacterBase.prototype.canPass = function(x, y, d) {
   ...
   //// console.log( $gameMap.roundYWithDirection(y, d) );////////////////::::::::::::loops xy nums.
...
Game_Character.prototype.processMoveCommand = function(command) {
    ...
    case gc.ROUTE_MOVE_TOWARD:
        this.moveTowardPlayer();
          //  console.log(this+"dildo");///                               [object Object]
           /// console.log(this.moveTowardPlayer);     //  manylogs  >  > 
        break;
...
function Game_Player() {
  ///  console.log("Shit");   ///   loops forever. jank
    this.initialize.apply(this, arguments);
}
...
Game_Event.prototype.list = function() {
    console.log(Game_Event.prototype);
