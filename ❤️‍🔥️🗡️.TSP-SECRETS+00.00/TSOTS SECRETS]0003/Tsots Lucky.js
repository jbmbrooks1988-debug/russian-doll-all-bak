...
Game_Message.prototype.setChoices = function(choices, defaultType, cancelType) {
    console.log("IIIIIIIIII:DDIDIDIDIDID****:");
...
Game_Switches.prototype.clear = function() {
    console.log(" MEEE t n GREEET");
    this._data = [];
};

//////(((((((((((((((((((())))))))))))))))))))///////////////GAMESWITCHES/////  / / //  G  A M  E  S W  I T  C H E S 
...
function Game_Variables() {
    this.initialize.apply(this, arguments);
    console.log("EXPERINMEMEME");
}

Game_Variables.prototype.initialize = function() {   ///////////////////////// ___   G A M  E  _  V  A R I A B L E  S ))) )  )____
    this.clear(); 
    console.log("NIGGERIAIAIAIN");
};
...
Game_Variables.prototype.onChange = function() {
    console.log("fdfdfdfddfdfdfdfdfdfdfdfdfdfdffdfdfd:");//////////////////////////////THEN THIS VAR
    $gameMap.requestRefresh();
};
...
////000009090909090990999899898988878787878776767676765656565554545443334433432222322211   _ _  _GAME PLAY ER NO
