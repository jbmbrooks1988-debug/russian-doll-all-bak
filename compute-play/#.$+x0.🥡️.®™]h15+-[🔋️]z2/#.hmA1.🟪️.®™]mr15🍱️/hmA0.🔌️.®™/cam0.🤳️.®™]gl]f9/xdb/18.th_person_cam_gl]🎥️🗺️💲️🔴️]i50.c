...
void draw_terminal() {
    ...
    // Fixed terminal dimensions in normalized coordinates
    float term_width = 0.88f; // Fixed width (50% of window) not wut broke thumb
    float term_height = 0.3f; // Fixed height (30% of window)
    float term_x = 0.0125f;
    float term_y = 0.0167f;
    float line_spacing = 0.025f; // Fixed spacing in normalized coordinates
