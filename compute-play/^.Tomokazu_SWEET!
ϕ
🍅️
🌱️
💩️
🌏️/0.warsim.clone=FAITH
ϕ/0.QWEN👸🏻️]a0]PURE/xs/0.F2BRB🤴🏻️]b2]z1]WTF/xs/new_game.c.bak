...
void handle_random_events(int* gold, int* men, int* faction_strength) {
    ...
    switch (event) {
        ...
        case 2:
            ...
            break;
        case 3:
            printf("one of your enlisted Knights wins a tournament in a nearby kingdom\n");
