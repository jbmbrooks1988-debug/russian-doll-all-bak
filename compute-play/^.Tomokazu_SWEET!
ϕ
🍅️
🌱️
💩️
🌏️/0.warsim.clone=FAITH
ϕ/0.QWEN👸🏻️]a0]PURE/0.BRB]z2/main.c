...
int main() {
    ...
    while (1) {
        ...
        printf("           \\\\|___|____|//\n");
        printf("            {//}====={\\}\n");
        printf("        [ CROWN OF CHARM ]\n");
        printf("[Welcome to T.E.M.T.: Raising the Starlight Princess (Full Release 1.0.0) ]\n");
        printf("1) Start a New Life\n");
        printf("2) Load a Savefile\n");
        printf("3) Quickstart (Instant new life)\n");
        printf("4) Options and Settings\n");
        printf("5) Start a new Challenge Mode (Strict Mom Edition)\n");
        printf("6) Extras and Outfit Generators\n");
        printf("7) Report a bug/Suggest a feature\n");
        printf("8) Community Links (Fashion Forums)\n");
        printf("9) View your Popularity Scores\n");
