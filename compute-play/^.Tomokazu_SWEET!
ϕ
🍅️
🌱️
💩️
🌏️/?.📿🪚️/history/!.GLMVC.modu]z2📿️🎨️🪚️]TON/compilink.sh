...
gcc main.o view_gl.o model_gl.o controller_gl.o -o candy_crush -pthread -lm -lssl -lcrypto -lGL -lGLU -lglut -lfreetype -lavcodec -lavformat -lavutil -lswscale -lX11 -L/usr/local/lib -lOpenCL
rm *.o
