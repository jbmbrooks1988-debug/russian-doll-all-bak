...
int main() {
    ...
    // Step 4: List all directories recursively from the user's inventory
    list_directories_recursive(user_inventory_path);

    // Step 5: Read emojis from inventory_lut.txt
    ...
    // Step 6: Filter directories and write to inventory_map.txt
    ...
    // Step 7: Let user choose a directory
